...
if ($_POST["login"] == "3220102682" && $_POST["pass"] == "2682") {
    ...
    echo ", Port: " . $_SERVER["REMOTE_PORT"] . "<br/><br/>";

    // 增加两个链接
    echo "<a href='test.txt' target='_blank'>Open test.txt</a><br/>";
    echo "<a href='/doc/test.pdf' target='_blank'>Open test.pdf</a><br/>";
} else {
    die("Login Failed</h1></body></html>");    
}
?>
    </h1>
</body>
